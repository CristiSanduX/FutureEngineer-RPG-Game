...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 31; i <= 33; i++)
            Tile.streetTile.DrawStreet(g, i * Tile.TILE_WIDTH, Tile.TILE_HEIGHT);
        for (int i = 16; i <= 30; i++)
            Tile.streetTile.DrawStreet(g, i * Tile.TILE_WIDTH, 18 * Tile.TILE_WIDTH);  //Stradă
        ...
        Tile.mcdonaldTile.DrawMcDonalds(g2, 16 * Tile.TILE_WIDTH, 9 * Tile.TILE_WIDTH);
        Tile.kfcTile.DrawKFC(g2, 2 * Tile.TILE_WIDTH, 15 * Tile.TILE_WIDTH);
        Tile.ACTile.Draw2(g2, 0, 0);                                                    //Clădiri

        Tile.carTile.DrawOpelCar(g2, 32 * Tile.TILE_WIDTH, 2 * Tile.TILE_HEIGHT);
        Tile.BMWCarTile.DrawBMWCar(g2, 32 * Tile.TILE_WIDTH, 3 * Tile.TILE_HEIGHT);
